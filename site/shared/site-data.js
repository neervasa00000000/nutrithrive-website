...
window.NT_SITE_DATA = {
  ...
  products: [
    ...
    },
    {
      ...
      pdp: {
        ...
        intro: 'Four 100g packs of the same shade-dried powder — useful if you cook for a family or go through a pouch quickly. Free shipping on orders $79+.',
        features: [
        ...
        faqs: [
          ...
          { q: 'Is shipping free?', a: 'Free shipping on Australian orders $79+. A $35 order is under that threshold, so standard shipping applies at checkout.' },
        ],
        showLabBadge: true,
        variantPicker: true,
      },
  ...
  moringaVariants: [
    { id: 'moringa-400g', label: '400g Moringa Bundle — $35.00', price: 35, was: 35, weight: 400 },
  ...
  testimonials: [
    { quote: "Black tea is my fav product here!! I usually use their black tea to make roasted milk tea which is fantastic for such hot summer in Melbourne!", author: "Mai Anh Trần Thúy", meta: 'via Google Reviews', initials: "MA", avatarBg: 'bg-primary-fixed' },
    { quote: "I have used various brands of moringa powder but the powder from Nutri-Thrive is the greenest in color and tastes way better than the other moringa powder in the market. The pricing is very reasonable and the shipping was also very quick!!", author: "Jay Turakhia", meta: 'via Google Reviews', initials: "JT", avatarBg: 'bg-tertiary-fixed' },
    ...
    { quote: "The product is super good and healthy I would definitely like to buy more and again!! Thanks for amazing product it helped me.", author: "Jay Rohit Sharma", meta: 'via Google Reviews', initials: "JR", avatarBg: 'bg-surface-container-high' },
    { quote: "Friendly people and good quality products and most of all pretty cheap. Love that!!", author: "Siv Mey", meta: 'via Google Reviews', initials: "SM", avatarBg: 'bg-secondary-fixed' },
  ...
  faqCategories: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'What is the free shipping threshold?', a: 'Free shipping Australia-wide on orders of AU$79+ and free worldwide shipping on orders of AU$90+.' },
  ...
  footerNav: [
    {
      ...
      links: [
        ...
        { label: 'Shipping & Returns', file: '/shipping' },
