/**
 * MediFlow AI — browser-only SOAP note generator.
...
Patient: Thank you, doctor.`;
    ...
    generateBtn.addEventListener("click", async () => {
      try {
        ...
        setStatus("SOAP note generated — review before use in any EHR.", "done");
      } catch (err) {
        output.textContent = "";
    ...
    copyBtn?.addEventListener("click", async () => {
      ...
      try {
        ...
        setStatus("Copied SOAP note to clipboard.", "done");
      } catch (e) {
    ...
    downloadBtn?.addEventListener("click", () => {
      ...
      a.download = "mediflow-soap-note.txt";
      a.click();
      URL.revokeObjectURL(a.href);
      setStatus("Downloaded SOAP note.", "done");
    });
