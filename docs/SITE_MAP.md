...
### About & Company Info
- `/pages/about/about.html` - About page (detailed)

### Benefits & Usage
- `/pages/benefits/moringa-benefits.html` - Moringa benefits page
- `/pages/usage-guide/how-to-use-moringa.html` - How to use Moringa guide

### Contact & Support
- `/pages/contact/contact.html` - Contact page
- `/pages/contact/index.html` - Contact index
- `/pages/contact/thank-you.html` - Contact form thank you

### FAQ & Help
- `/pages/faq/faq.html` - FAQ page
...
### Newsletter
- `/pages/newsletter/index.html` - Newsletter signup
- `/pages/newsletter/thank-you.html` - Newsletter thank you
...
- `/blog/black-tea-benefits-caffeine-australia.html`
...
- `/blog/best-clean-protein-powder-australia-2026-lab-tested-reviews-comparison-expert-buyers-guide.html`
...
- `/blog/moringa-vs-matcha-superfood-comparison-melbourne-2026.html`
...
- `/blog/10-dollar-superfood-replaced-200-supplement-stack-australia-2026.html`
- `/blog/10-healthiest-foods-world-complete-guide-australia-2026.html`
- `/blog/15-healthy-breakfast-meals-australians-love-2026.html`
...
### Other Blog Posts
- `/blog/best-moringa-powder-australia-2025.html`
- `/blog/moringa-brands-comparison-australia-chinese-review.html`
...
- `/blog/index.html` - Blog index (alternate)
...
- **Blog Posts:** 98 articles
- **Pages Directory:** 15 pages
- **Utility Pages:** 1 page
- **Total:** 129+ pages

### By Priority
- **Priority 1.0:** Homepage (2 URLs)
- **Priority 0.9:** Products, Key Blog Posts (15+ pages)
- **Priority 0.8:** Main Pages, Important Blog Posts (40+ pages)
- **Priority 0.7:** Regular Blog Posts (60+ pages)
- **Priority 0.6:** Lower Priority Pages (5+ pages)
- **Priority 0.5:** Utility/Thank You Pages (5+ pages)

---

## 🔗 Key Internal Link Structure
...
│   └── Moringa Soap (/products/product-moringa-soap.html)
├── Blog (/blog/)
│   └── [98 Blog Posts]
├── About (/about.html)
...
### Blog Categories
- **Moringa Guides:** 30+ posts
- **Curry Leaves:** 14+ posts
- **Black Tea:** 4+ posts
- **Protein & Fitness:** 8+ posts
- **Health & Wellness:** 25+ posts
- **Comparison Guides:** 10+ posts
- **Other Topics:** 7+ posts

---

## 📝 Notes

- All blog posts are accessible via `/blog/[filename].html`
- Product pages use both `/products/` and `/pages/products/` directories
- Some pages have multiple URL paths (e.g., `/about.html` and `/about`)
- PayPal integration pages: `/cart.html`, `/thank-you.html`
- Newsletter pages: `/pages/newsletter/`
