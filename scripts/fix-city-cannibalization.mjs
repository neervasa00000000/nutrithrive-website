...
const REPLACEMENTS = [
  {
    ...
    from: 'Lab-tested moringa powder shipped Australia-wide from Melbourne. Same-day dispatch before 2pm. Free shipping over $49.50. Sydney, Brisbane, Perth &amp; all states.',
    to: 'Lab-tested moringa powder from our Truganina warehouse. Same-day dispatch before 2pm on business days. Free shipping over $49.50 Australia-wide.',
  },
  {
    file: 'index.html',
