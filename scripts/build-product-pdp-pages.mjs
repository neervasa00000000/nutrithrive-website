...
function buybox(p) {
  ...
  const trust = (p.trust || ['Melbourne Packed', 'Same Day Dispatch', 'Free Shipping Over $49.50'])
...
const products = [
  {
    ...
    trust: ['Shade-Dried Leaves', 'Same Day Dispatch', 'Free Shipping Over $49.50'],
    features: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Payments & shipping?', a: 'Visa, bank transfer, cash, and PayPal. Free AU shipping on orders $49.50+. Dispatch within 2 business days.' },
    ],
    disclaimer: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Payments & shipping?', a: 'Free AU shipping on orders $49.50+. Dispatch within 2 business days from Melbourne.' },
    ],
    disclaimer: [
      '<strong>Legal disclaimer:</strong> NutriThrive is operated from Truganina, VIC (ABN 32 639 442 616).',
  ...
  {
    file: 'products/gift-pack/index.html',
    crumb: 'Gift Pack',
    h1: 'Gift Pack',
    price: 35, was: 41.98,
    ...
    features: [
      { icon: ICONS.box, title: 'Four Products', text: '100g moringa, 100g tea, 30g curry leaves, 95g soap.' },
      { icon: ICONS.check, title: 'Lab-Tested Moringa', text: 'Shade-dried moringa with NMI summary on file.' },
      { icon: ICONS.leaf, title: 'Curry Leaves', text: '30g dried kari leaf for tadka and dals.' },
      { icon: ICONS.soap, title: 'Moringa Soap', text: '95g moringa lavender bar for everyday use.' },
    ],
    sideCard: { title: "What's in the box", body: '<strong>100g</strong> moringa powder · <strong>100g</strong> Darjeeling black tea · <strong>30g</strong> dried curry leaves · <strong>95g</strong> moringa lavender soap. Ready to gift.', note: 'Gift pack $35.00 (RRP $41.98)' },
    aboutTitle: 'About the Gift Pack',
    aboutParas: [
      '100g moringa powder, 100g Darjeeling black tea, 30g dried curry leaves, and one 95g moringa lavender soap — a complete NutriThrive set in one gift-ready order.',
      'Moringa is NMI lab-tested; tea, curry leaves, and soap are packed in the same Truganina warehouse. Ideal for birthdays, host gifts, and wellness baskets.',
    ],
    meta: [
      { dt: 'Best for', dd: 'Gifting, housewarmings, and anyone wanting the full NutriThrive lineup.' },
      { dt: 'Dispatch', dd: 'Same-day Melbourne dispatch before 2pm on business days.' },
    ],
    howTitle: 'How to Enjoy the Gift Pack',
    howSub: 'Four everyday uses from one set.',
    howCards: [
      { title: 'Morning', text: '½–1 tsp moringa in a smoothie or juice.' },
      { title: 'Afternoon', text: 'Steep Darjeeling at 85–90°C, or unwrap the soap for a lavender cleanse.' },
      { title: 'Evening', text: 'Fry curry leaves in ghee for dal, rice, or vegetable dishes.' },
    ],
    reviewsRating: '4.9/5 · 12 Google reviews',
    reviews: [
      { stars: 5, quote: '"I have used various brands of moringa powder but the powder from Nutri-Thrive is the greenest in color and tastes way better than the other moringa powder in the market."', initials: 'JT', name: 'Jay Turakhia', meta: 'via Google Reviews' },
      { stars: 5, quote: '"Black tea is my fav product here!! I usually use their black tea to make roasted milk tea which is fantastic for such hot summer in Melbourne!"', initials: 'MA', name: 'Mai Anh Trần Thúy', meta: 'via Google Reviews' },
      { stars: 5, quote: '"This product is healthy, of excellent quality, and very affordable. Highly recommend!"', initials: 'RR', name: 'reetysha ramjee', meta: 'via Google Reviews' },
    ],
    reviewsNote: 'Quotes from our Google Business Profile. Individual experiences only.',
    guides: [
      { href: '/blog/how-to-add-moringa-to-diet', label: 'How to add moringa to your diet' },
      { href: '/blog/nutrithrive-dried-curry-leaves-tradition-health', label: 'Curry leaves guide' },
      { href: '/products/moringa-powder/', label: 'Moringa powder (single)' },
      { href: '/products/black-tea/', label: 'Darjeeling tea (single)' },
      { href: '/products/curry-leaves/', label: 'Dried curry leaves' },
      { href: '/products/moringa-soap/', label: 'Moringa lavender soap' },
    ],
    faqs: [
      ...
      { q: 'Payments & shipping?', a: 'Free AU shipping on orders $49.50+. Same-day dispatch before 2pm on business days when possible; otherwise within 2 business days from Melbourne.' },
    ],
    disclaimer: [
      '<strong>Legal disclaimer:</strong> NutriThrive is operated from Truganina, VIC (ABN 32 639 442 616).',
      '<strong>These statements have not been evaluated by the TGA.</strong> Products are food ingredients, not intended to treat disease.',
