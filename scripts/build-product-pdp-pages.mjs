...
function buybox(p) {
  ...
  const trust = (p.trust || ['Melbourne Packed', 'Same Day Dispatch', 'Free Shipping Over $79'])
...
const products = [
  {
    ...
    trust: ['Shade-Dried Leaves', 'Same Day Dispatch', 'Free Shipping Over $79'],
    features: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Payments & shipping?', a: 'Visa, bank transfer, cash, and PayPal. Free AU shipping on orders $79+. Dispatch within 2 business days.' },
    ],
    disclaimer: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Payments & shipping?', a: 'Free AU shipping on orders $79+. Dispatch within 2 business days from Melbourne.' },
    ],
    disclaimer: [
      '<strong>Legal disclaimer:</strong> NutriThrive is operated from Truganina, VIC (ABN 32 639 442 616).',
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Payments & shipping?', a: 'Free AU shipping on orders $79+. Same-day dispatch before 2pm on business days when possible; otherwise within 2 business days from Melbourne.' },
    ],
    disclaimer: [
      '<strong>Legal disclaimer:</strong> NutriThrive is operated from Truganina, VIC (ABN 32 639 442 616).',
      '<strong>These statements have not been evaluated by the TGA.</strong> Products are food ingredients, not intended to treat disease.',
