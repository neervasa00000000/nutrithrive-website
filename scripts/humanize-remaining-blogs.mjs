...
const FOUNDER_NOTES = {
  ...
  'buy-moringa-powder-melbourne-victoria-chinese-guide.html':
    '<p style="margin:0 0 0.75rem 0;">我是 Neer Vasavada，在墨尔本 Truganina 仓库发货。这篇是购买与品质说明，不是医疗建议。</p><p style="margin:0 0 0.75rem 0;">Moringa / 辣木粉在澳洲属于食品补充剂，不能宣称治疗疾病。有病史或服药请先咨询医生。</p><p style="margin:0;">English: food supplement only — see your GP for medical questions.</p>',
  'does-moringa-have-caffeine-truth-about-energy-focus-side-effects-2026.html':
    '<p style="margin:0 0 0.75rem 0;">Neer Vasavada, NutriThrive — Truganina warehouse. People ask us daily if moringa is "like coffee." It isn\'t; leaf powder has no caffeine.</p><p style="margin:0 0 0.75rem 0;">Feeling more alert can come from nutrition in your diet — not from a stimulant. That\'s food support, not a treatment for sleep disorders or ADHD.</p><p style="margin:0;">On medication or pregnant? Ask your GP before adding any new powder.</p>',
