...
FAQS = [
    ...
    (
        ...
        "Free Australia-wide standard shipping on orders $79 and over, per the live site today.",
    ),
    (
...
<p>100% leaf, packed in Truganina. Use within 18 months after opening if you keep it sealed, cool and dry. Same-day weekday dispatch before 2pm. Free AU shipping at $79.</p>
<div class="btn-row">
...
<ul>
<li><strong>3 Sep 2026:</strong> Shelf-life refresh on this same URL. Opened window aligned to the live PDP (use within 18 months). Australian spring heat, fridge condensation, pack dates from Truganina. Free AU shipping at $79.</li>
