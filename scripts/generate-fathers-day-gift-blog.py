...
FAQS = [
    ...
    (
        ...
        "$35 + $9.69 = $44.69 if the order is under $79. Free shipping at $79+. Pickup is $35.",
    ),
    (
...
<p class="text-body-sm text-on-surface-variant mb-6">Free shipping over $79 · Pickup by arrangement</p>
