...
(function () {
  ...
  function injectJSONLD() {
    ...
    const products = [
      { name: 'NutriThrive Moringa Powder', price: PRICES.moringa.price, unit: PRICES.moringa.unit, url: PRICES.moringa.url, image: 'https://nutrithrive.com.au/assets/images/product_photos/webp/moringa.webp', description: '100% pure Moringa Oleifera leaf powder. Packed with antioxidants, vitamins, and minerals, perfect for boosting energy and supporting a healthy immune system.' },
      { name: 'NutriThrive Dried Curry Leaves', price: PRICES.curry.price, unit: PRICES.curry.unit, url: PRICES.curry.url, image: 'https://nutrithrive.com.au/assets/images/product_photos/webp/driedcurry.webp', description: 'Premium dried curry leaves from our own farm. Traditional Indian spice with health benefits. 100% natural, perfect for authentic Indian cooking.' },
      { name: 'NutriThrive Darjeeling Black Tea', price: PRICES.tea.price, unit: PRICES.tea.unit, url: PRICES.tea.url, image: 'https://nutrithrive.com.au/assets/images/product_photos/webp/blacktea.webp', description: 'Premium Darjeeling black tea with rich aroma and smooth, balanced taste. Perfect for mornings or afternoon pick-me-up.' }
    ];
    const prodLD = {
