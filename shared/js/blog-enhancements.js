...
(function () {
  ...
  function injectJSONLD() {
    ...
    const products = [
      { name: 'NutriThrive Moringa Powder', price: PRICES.moringa.price, unit: PRICES.moringa.unit, url: PRICES.moringa.url, image: 'https://nutrithrive.com.au/assets/images/og/moringa-social-1200.png', description: '100% pure Moringa Oleifera leaf powder. Packed with antioxidants, vitamins, and minerals, perfect for boosting energy and supporting a healthy immune system.' },
      { name: 'NutriThrive Dried Curry Leaves', price: PRICES.curry.price, unit: PRICES.curry.unit, url: PRICES.curry.url, image: 'https://nutrithrive.com.au/assets/images/homepage/product-showcase/Curry.webp', description: 'Premium dried curry leaves from our own farm. Traditional Indian spice with health benefits. 100% natural, perfect for authentic Indian cooking.' },
      { name: 'NutriThrive Darjeeling Black Tea', price: PRICES.tea.price, unit: PRICES.tea.unit, url: PRICES.tea.url, image: 'https://nutrithrive.com.au/assets/images/og/black-tea-social-1200.jpg', description: 'Premium Darjeeling black tea with rich aroma and smooth, balanced taste. Perfect for mornings or afternoon pick-me-up.' }
    ];
    const prodLD = {
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    try {
      ...
      const newPath = '/blog/what-does-moringa-do-for-your-body-complete-guide-2026.html';
    ...
    try {
      ...
      anchors.forEach(a => {
        ...
        if (href.includes('/pages/usage-guide/blog/moringa-powder-benefits-ultimate-guide-2024.html') || href.includes('usage-guide/blog/moringa-powder-benefits-ultimate-guide-2024.html')) {
          a.setAttribute('href','/blog/what-does-moringa-do-for-your-body-complete-guide-2026.html');
        }
