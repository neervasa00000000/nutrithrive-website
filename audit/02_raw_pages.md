...
| 17 | `/blog/how-to-add-moringa-to-diet.html` | How to add moringa (diet hub) | Retired standalone usage page merged here (301 from old paths) | Article H1 | many | many | long | many | — | `.html` | index, follow | Article |
...
| 43 | `blog/10-dollar-superfood-replaced-200-supplement-stack-australia-2026.html` | (In sitemap) | (Not in primary scrape batch) | — | — | — | — | — | — | — | In sitemap: index (assumed) | In sitemap only here |
| 44 | `blog/where-to-buy-moringa-in-australia-online-vs-stores-2026-guide.html` | (In sitemap) | Pillar: channels vs DTC | — | — | — | — | — | — | — | In sitemap | High commercial intent |
| 45 | `blog/moringa-vs-spirulina-vs-matcha-comparison-australia.html` | (In sitemap) | Head-to-head superfoods | — | — | — | — | — | — | — | In sitemap | Article |
| 46 | `blog/does-moringa-have-caffeine-truth-about-energy-focus-side-effects-2026.html` | (In sitemap) | Caffeine FAQ | — | — | — | — | — | — | — | In sitemap | Article |
| 47 | `blog/melbourne-body-burden-report-2026.html` | (In sitemap) | Local / env-health angle | — | — | — | — | — | — | — | In sitemap | Article |
| 48 | `blog/moringa-powder-vs-capsules-which-one-actually-works-better-2026.html` | (In sitemap) | Format comparison (money page) | — | — | — | — | — | — | — | In sitemap | Article; links to product |
| 49 | `nutrithrive_labs/sitemap-generator.html` | (In sitemap; not in main scrape) | Free tool page | TBD on rescrape | — | — | — | — | — | self | In sitemap | SoftwareApplication candidate |

**Rows 43–49:** Listed in [sitemap.xml](../sitemap.xml); earlier rows carry the main scrape detail. **Index gaps** (e.g. missing #26) reflect pages removed from the live site since this table was first captured. **Meta boilerplate** (“from NutriThrive… Explore practical guidance…”) was observed on e.g. **Contact** and **How to add moringa** — treat as duplicate meta pattern to fix.
...
- **Retired URLs:** Old usage-guide and off-topic gym / protein posts were removed (May 2026); legacy paths 301/404 via `_redirects` and `.htaccess`. Canonical “how to use” content lives at `/blog/how-to-add-moringa-to-diet.html`.
